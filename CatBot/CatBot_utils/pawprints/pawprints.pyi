...
class _LoggerOutput:
    ...
    @abstractmethod
    def send(self, message: Union[SupportsStr, SupportsRepr], /) -> None: ...
    @property
    def id(self) -> int: ...
...
class Logger:
    ...
    def cmd_call(self, message: Union[SupportsStr, SupportsRepr], /) -> None: ...
    ...
    def add_output(self, output: _LoggerOutput, /) -> None: ...
    @overload
    def remove_output(self, output: _LoggerOutput, /) -> None: ...
    @overload
    ...
    @property
    def outputs(self) -> List[_LoggerOutput]: ...
    @property
    def id(self) -> int: ...
    @property
    def level(
...
def config_root(
    *,
    ...
    outputs: Optional[Sequence[_LoggerOutput]] = None,
...
def cmd_call(message: Union[SupportsStr, SupportsRepr], /) -> None: ...
